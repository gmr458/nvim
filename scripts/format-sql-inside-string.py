...
result = sqlparse.format(
    ...
    reindent=False,  # If True the indentations of the statements are changed
    reindent_aligned=False,  # If True the indentations of the statements are changed, and statements are aligned by keywords
